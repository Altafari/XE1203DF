...
static void multiply_f0_convert12bitU_to_q15(uint16_t* pIn, q15_t* pOutI, q15_t* pOutQ, uint16_t nSamples);
...
//    HAL_GPIO_WritePin(GPIOA, GPIO_PIN_10, GPIO_PIN_SET);
    multiply_f0_convert12bitU_to_q15(pBuff, fir_stage1_input_i, fir_stage1_input_q, FIR_STAGE1_BLOCK_SIZE);
    arm_fir_decimate_fast_q15(&fir_stage1_i, fir_stage1_input_i, fir_stage2_input_i, FIR_STAGE1_BLOCK_SIZE);
    arm_fir_decimate_fast_q15(&fir_stage2_i, fir_stage2_input_i, output_buffer_i, FIR_STAGE2_BLOCK_SIZE);
    arm_fir_decimate_fast_q15(&fir_stage1_q, fir_stage1_input_q, fir_stage2_input_q, FIR_STAGE1_BLOCK_SIZE);
    arm_fir_decimate_fast_q15(&fir_stage2_q, fir_stage2_input_q, output_buffer_q, FIR_STAGE2_BLOCK_SIZE);
